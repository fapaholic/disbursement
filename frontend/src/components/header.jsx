...
const Header = () => {
    ...
    return (
        <nav className="flex justify-between p-5 items-center border-b bg-black ">
            <div className="flex gap-2">
            <img src={logo} className="w-20 bg-cover"/>
            <h1 className="text-3xl mt-5 text-white">BSIT Disbursement System</h1>
            </div>
            <ul className="hidden md:flex gap-40 text-2xl text-white">
                <Link to = {'/Home'}><li className="hover:text-green-700">Home</li></Link>
           ...
           <ul className={`${
            ...
            `} onClick={() => setNav (false)}>
                <Link to = {'/Home'}><li className="p-2 hover:text-green-700 hover:font-bold">Home</li></Link>
                ...
                <Link to = {'/'}><li className="p-2 hover:text-green-700 ">Logout</li></Link>
           </ul>
        </nav>
    )
}
